 ...
 */
public class UpdateFinishTimeUseCase {

    private final ActivityRepository _activityRepository;

    public UpdateFinishTimeUseCase(ActivityRepository activityRepository) {
...
//                Completable
//                        .fromRunnable(() -> _activityRepository.updateFinishTime(activityModel))
