 ...
 */
public class UpdateStartTimeUseCase {

    private final ActivityRepository _activityRepository;

    public UpdateStartTimeUseCase(ActivityRepository activityRepository) {
...
//                Completable
//                        .fromRunnable(() -> _activityRepository.updateStartTime(activityModel))
